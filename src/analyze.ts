import type {BaseResult, ImageInput, Options, RawImage, ResolvedOptions, Result, Tile, TileResult} from './types.ts'
...
export const analyzeImage = (input: ImageInput, options: Options = {}): Result => {
